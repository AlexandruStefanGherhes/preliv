    ...
    return(
        <>
                <div className="companie-photo">
                    <img src="./public/assets/pexels.jpeg" alt="" />
                </div>
                <div className="companie">
                    ...
                    <div className="companie-iso">
                        <img src="./public/assets/iso1.jpeg" alt="certificat" />
                        <img src="./public/assets/iso2.jpeg" alt="certificat" />
                        <img src="./public/assets/iso3.jpeg" alt="certificat" />
                    </div>
                </div>
