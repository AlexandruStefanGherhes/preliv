    ...
    return(
        <>
                <div className="companie-photo">
                    <img src="./src/assets/pexels.jpeg" alt="" />
                </div>
                <div className="companie">
                    ...
                    <div className="companie-iso">
                        <img src="./src/assets/iso1.jpeg" alt="certificat" />
                        <img src="./src/assets/iso2.jpeg" alt="certificat" />
                        <img src="./src/assets/iso3.jpeg" alt="certificat" />
                    </div>
                </div>
